...
class m150719_080612_create_issue_user_and_assignment_tables extends CDbMigration
{
	...
	{
		$this-turncateTable('tbl_project_user_assignment');
		$this->turncateTable('tbl_issue');
		$this->turncateTable('tbl_user');
