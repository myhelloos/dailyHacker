...
{
	private static final long serialVersionUID = -8462046936183582022L;
   ...
   public void checkForWinner(){
	...
	private boolean findThreeInARow(){
	    if (("" != button1.getText() && button1.getText() == button2.getText() && button2.getText() == button3.getText()) ||
	    	("" != button4.getText() && button4.getText() == button5.getText() && button5.getText() == button6.getText()) || 
	        ("" != button7.getText() && button7.getText() == button8.getText() && button8.getText() == button9.getText()) ||
            ("" != button1.getText() && button1.getText() == button4.getText() && button4.getText() == button7.getText()) ||
            ("" != button2.getText() && button2.getText() == button5.getText() && button5.getText() == button8.getText()) ||
            ("" != button3.getText() && button3.getText() == button6.getText() && button6.getText() == button9.getText()) ||
            ("" != button1.getText() && button1.getText() == button5.getText() && button5.getText() == button9.getText()) ||
            ("" != button3.getText() && button3.getText() == button5.getText() && button5.getText() == button7.getText())
        )
	        return true;
	    else
	        return false;
